...
public class HealthSystem : MonoBehaviour
{
    ...
    public void TakeDamage(int amount, string attackerName)
    {
        ...
        np.networkObject.SendRpc(PlayerBehavior.RPC_TAKE_DAMAGE, BeardedManStudios.Forge.Networking.Receivers.All, health);
    ...
    {
        //Spawn the ragdoll
        GameObject ragdoll = Instantiate(np.gameObject, np.PlayerModel.transform.position, np.PlayerModel.transform.rotation);
